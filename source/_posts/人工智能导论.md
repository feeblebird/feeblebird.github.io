...
* knn算法介绍
  ...
  ![image.png](https://i.loli.net/2020/11/12/VMEqCTOlgxnwGWp.png)

  图中绿色的点就是我们要预测的那个点，假设K=3。那么KNN算法就会找到与它距离最近的三个点（这里用圆圈把它圈起来了），看看哪种类别多一些，比如这个例子中是蓝色三角形多一些，新来的绿色点就归类到蓝三角了。

  ![image.png](https://i.loli.net/2020/11/12/PU29brsAnMW8XD1.png)
...
* 距离计算
  ...
  ![image.png](https://i.loli.net/2020/11/12/M8rAT6NulLpJImD.png)

  这个高中应该就有接触到的了，其实就是计算（x1,y1）和（x2,y2）的距离。拓展到多维空间，则公式变成这样：

  ![image.png](https://i.loli.net/2020/11/12/5W4dwAbvnY9iyVh.png)
...
* k值选择
  ...
  ![image.png](https://i.loli.net/2020/11/12/VnhN8vqzP4rjBHU.png)
...
![image.png](https://i.loli.net/2020/11/12/Ps5mhRXSTWCupeU.png)
...
![image.png](https://i.loli.net/2020/11/12/DV7RsLv1qjnu9KN.png)
...
运行后，我们可以得到下面这样的图：
![image.png](https://i.loli.net/2020/11/12/2c3tSinaXPLTflv.png)
